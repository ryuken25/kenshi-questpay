    ...
    <section className="relative px-4 py-14 sm:px-6 sm:py-18 lg:px-8">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {SERVICES.map((svc, i) => (
            ...
            >
              ...
              <p className="mt-3 text-sm leading-6 text-gray-400">{svc.description}</p>
            </motion.div>
          ))}
        </div>
        ...
        <div className="mt-8 text-center">
          <Link
            href="/services"
            className="inline-flex min-h-11 items-center rounded-2xl bg-verse-purple/20 px-6 py-3 font-bold text-verse-purple border border-verse-purple/30 hover:bg-verse-purple/30 transition-all"
          >
            View all services →
          </Link>
        </div>
